...
func setupSupportingDB(t *testing.T) *gorm.DB {
	...
	tables := []string{
		...
		`CREATE TABLE field_groups (id INTEGER PRIMARY KEY, klass_name TEXT, label TEXT, name TEXT, tag_id INTEGER, position INTEGER, created_at DATETIME, updated_at DATETIME)`,
